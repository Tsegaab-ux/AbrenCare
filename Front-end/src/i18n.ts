      ...
      en: {
        translation: {
          ...
          story: {
            ...
            title: "Helping Families Thrive Through Better Healthcare",

            description:
              "We believe every family deserves compassionate, personalized healthcare. Our experienced team combines modern medical expertise with genuine care to help you live healthier, happier lives.",

            feature1: "Personalized Care",
            feature1Desc:
              "Every patient receives a treatment plan designed around their individual needs and health goals.",

            feature2: "Experienced Professionals",
            feature2Desc:
              "Our qualified healthcare team provides trusted medical care backed by years of clinical experience.",

            feature3: "Modern Technology",
            feature3Desc:
              "Advanced medical equipment helps us deliver accurate diagnoses and effective treatments."
          },
        }
      },
        ...
        translation: {
         ...
         beforeAfter: {
          ...
          story: {
            ...
            title: "ቤተሰቦች ጤናማና ደስተኛ ሕይወት እንዲኖራቸው እንረዳለን",

            description:
              "እያንዳንዱ ቤተሰብ ርኅራኄ የተሞላበትና ለእነርሱ የተስማማ የጤና እንክብካቤ ሊያገኝ እንደሚገባ እናምናለን። የባለሙያዎቻችን ቡድን ዘመናዊ የሕክምና እውቀትን ከልባዊ እንክብካቤ ጋር በማጣመር ጤናማና ደስተኛ ሕይወት እንዲኖሩ ይረዳዎታል።",

            feature1: "ለእያንዳንዱ ሰው የተለየ እንክብካቤ",
            feature1Desc:
              "እያንዳንዱ ታካሚ ከጤናውና ከፍላጎቱ ጋር የሚስማማ የሕክምና እቅድ ያገኛል።",

            feature2: "ልምድ ያላቸው ባለሙያዎች",
            feature2Desc:
              "ብቁ የጤና ባለሙያዎቻችን በረጅም ዓመታት ልምድ የተደገፈ የሚታመን የሕክምና አገልግሎት ይሰጣሉ።",

            feature3: "ዘመናዊ የሕክምና ቴክኖሎጂ",
            feature3Desc:
              "የላቀ የሕክምና መሣሪያዎችን በመጠቀም ትክክለኛ ምርመራና ውጤታማ ሕክምና እንሰጣለን።"
          },
        }
      }
    },
