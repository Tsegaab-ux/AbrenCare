  ...
  return (
    <section id="waitlist" className="bg-[#F8F4EE] py-22 px-6 lg:px-8">
      ...
      <div className="max-w-[580px] mx-auto text-center">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-[#F2ECE5] border border-[#E7DED3] text-[#B88A44] px-4 py-1.5 rounded-full text-[11px] font-semibold mb-5">
        ...
        <div className="bg-white border-[1.5px] border-[#E7DED3] rounded-2xl p-9 mt-7 text-left shadow-[0_16px_48px_rgba(0,0,0,0.07)]">
          ...
          <div className="bg-[#F2ECE5] rounded-xl p-2.5 flex items-center gap-3 mb-6 border border-[#E7DED3]">
            <div className="flex-1 h-1.5 bg-[#E7DED3] rounded-full overflow-hidden">
              <div className="h-full w-[28%] bg-[#B88A44] rounded-full"></div>
            </div>
            <div className="text-xs font-semibold text-[#B88A44] whitespace-nowrap">
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full bg-[#B88A44] hover:bg-[#A67A37] text-white py-4 rounded-xl font-bold text-base transition-all duration-300"
              >
                {t("waitlist.button")}
              </button>
