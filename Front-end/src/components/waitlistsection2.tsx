  ...
  return (
    <section id="waitlist" className="bg-[#F8F4EE] py-22 px-6 lg:px-8">
      ...
      <div className="max-w-[580px] mx-auto text-center">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-[#F2ECE5] border border-[#E7DED3] text-[#3B82F6] px-4 py-1.5 rounded-full text-[11px] font-semibold mb-5">
        ...
        <div className="bg-white border-[1.5px] border-[#E7DED3] rounded-2xl p-9 mt-7 text-left shadow-[0_16px_48px_rgba(0,0,0,0.07)]">
          ...
          <div className="bg-[#F2ECE5] rounded-xl p-2.5 flex items-center gap-3 mb-6 border border-[#E7DED3]">
            <div className="flex-1 h-1.5 bg-[#E7DED3] rounded-full overflow-hidden">
              <div className="h-full w-[28%] bg-gradient-to-r from-[#93C5FD] to-[#3B82F6] rounded-full"></div>
            </div>
            <div className="text-xs font-semibold text-[#3B82F6] whitespace-nowrap">
          ...
          {!submitted ? (
            <form onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3.5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border-[1.5px] border-[#E7DED3] rounded-xl text-sm bg-white focus:border-[#3B82F6] outline-none focus:ring-2 focus:ring-[#93C5FD] focus:ring-opacity-50"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-[#93C5FD] to-[#3B82F6] hover:from-[#3B82F6] hover:to-[#2563EB] text-white py-4 rounded-xl font-bold text-base hover:-translate-y-0.5 hover:shadow-[0_14px_35px_rgba(59,130,246,0.35)] transition-all duration-300"
              >
                {t("waitlist.button")}
              </button>
